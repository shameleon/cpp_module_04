...
{
	std::cout << EMO_WRENCH << " (WrongAnimal default constructor): a default WrongAnimal was created. ";
...
{
	std::cout << EMO_WRENCH << " (WrongAnimal parametric constructor): a new WrongAnimal was created. ";
	std::cout << "it is a " << this->_type << " ! " << std::endl;
	return ;
}
...
{
	std::cout << EMO_WRENCH << " (WrongAnimal copy constructor): a clone of " << this->getType();
...
{
	std::cout << COL_RED << EMO_MINUS << " (WrongAnimal destructor): RIP little ";
...
WrongAnimal		&WrongAnimal::operator=(WrongAnimal const &rhs)
{
	if (this == &rhs)
		return (*this);
	std::cout << EMO_WRENCH << " (WrongAnimal copy assignment operator): ";
...
{
	std::cout << EMO_MINUS << " (WrongAnimal Makes Sound): wrong sound";
	std::cout << std::endl;
	return ;
}
